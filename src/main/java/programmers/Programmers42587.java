...
/**
 * 프로그래머스
 * - 코딩테스트 연습 - 스택/큐 - 프로세스 (https://school.programmers.co.kr/learn/courses/30/lessons/42587)
 *
 * 문제 설명
...
public class Programmers42587 {
    ...
    public static void main(String[] args) {
        final int[] priorities1 = {2, 1, 3, 2};
        final int[] priorities2 = {1, 1, 9, 1, 1, 1};

        final int location1 = 2;
    ...
    public static int solution(int[] priorities, int location) {
        final Queue<Process> queue = new LinkedList<>();
        ...
        int count = 0;
        while (!queue.isEmpty()) {
            final Process current = queue.poll();

            // 큐 내에 우선순위가 더 높은 것이 있는지 체크
    ...
    static class Process {
        ...
        public Process(final int priority, final int index) {
