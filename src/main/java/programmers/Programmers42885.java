...
/**
 * 프로그래머스
 * - 코딩테스트 연습 - 탐욕법(Greedy) - 구명보트 (https://school.programmers.co.kr/learn/courses/30/lessons/42885)
 *
 * 문제 설명
...
public class Programmers42885 {
    ...
    public static int solution(int[] people, int limit) {
        ...
        while (lt <= rt) {
            final int first = people[lt];
            final int last = people[rt];

            // 가벼운 사람은 2명 태울수 있을 때만
            if (first + last <= limit) lt++;
