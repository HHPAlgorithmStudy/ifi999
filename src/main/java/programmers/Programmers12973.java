...
/**
 * 프로그래머스
 * - 코딩테스트 연습 - 2017 팁스다운 - 짝지어 제거하기 (https://school.programmers.co.kr/learn/courses/30/lessons/12973)
 *
 * 문제 설명
...
public class Programmers12973 {
    ...
    public static void main(String[] args) {
        final String s1 = "baabaa";
        final String s2 = "cdcd";
    ...
    public static int solution(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            // sb가 비어 있지 않고, 마지막 문자와 현재 문자가 같다면 제거
