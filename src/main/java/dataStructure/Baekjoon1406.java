...
public class Baekjoon1406 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (n-- > 0) {
            ...
            char command = nextStr.charAt(0);

            if (command == 'L' && !leftStack.isEmpty()) {
                final Character word = leftStack.pop();
                rightStack.push(word);
            }
            else if (command == 'D' && !rightStack.isEmpty()) {
                final Character word = rightStack.pop();
                leftStack.push(word);
            }
            else if (command == 'B') {
                ...
                final Character word = nextStr.charAt(2);
                leftStack.push(word);
            }
        }
